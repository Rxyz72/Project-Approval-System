    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "AI, deep learning, neural networks", true, "Artificial Intelligence" },
                    { 2, "Frontend, backend, full-stack development", true, "Web Development" },
                    { 3, "Network security, ethical hacking, cryptography", true, "Cybersecurity" },
                    { 4, "AWS, Azure, GCP, distributed systems", true, "Cloud Computing" },
                    { 5, "ML algorithms, data science, model training", true, "Machine Learning" },
                    { 6, "iOS, Android, cross-platform apps", true, "Mobile Development" },
                    { 7, "Data analysis, visualization, big data", true, "Data Science" }
                });
